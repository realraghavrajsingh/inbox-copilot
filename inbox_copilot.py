...
def get_redirect_uri():
    ...
    if os.environ.get('K_SERVICE'):
        return f"https://inbox-copilot-165125627588.us-central1.run.app"
    # Local development
...
# Page Configuration
st.set_page_config(page_title="Inbox Copilot", page_icon="🚀", layout="wide", initial_sidebar_state="collapsed")

# Force title change immediately with JavaScript
st.markdown("""
<script>
    document.title = "🚀 Inbox Copilot";
    // Also update favicon
    ...
    // Keep checking and updating title
    setInterval(function() {
        if (document.title !== "🚀 Inbox Copilot") {
            document.title = "🚀 Inbox Copilot";
        }
    }, 100);
</script>
...
def render_landing_page():
    ...
    <body>
        ...
        <!-- Navbar -->
        <nav class="navbar">
            <div class="logo"><span class="logo-icon">🚀</span> Inbox Copilot</div>
            <div class="nav-links">
                <a href="#">Features</a>
                <a href="#">Pricing</a>
                <a href="#">FAQ</a>
            ...
            <div class="hero-right">
                <div class="dashboard-card">
                    <div class="card-header">
                        <div class="card-logo"><span class="card-logo-icon">🚀</span><span>Inbox Copilot</span></div>
    ...
    with col2:
        if IS_CLOUD:
            auth_url = get_google_auth_url()
            if auth_url:
                st.link_button("🚀 Get Started for Free", auth_url, use_container_width=True)
            else:
                st.error("OAuth not configured")
        else:
            if st.button("🚀 Get Started for Free", use_container_width=True):
    ...
    # Footer is now included in the landing page HTML above
